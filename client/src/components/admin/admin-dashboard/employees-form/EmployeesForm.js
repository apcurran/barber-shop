...
import {
    addEmployee,
    patchEmployee,
} from "../../../../store/actions/admin-employees-actions";
...
function EmployeesForm({ isNewEmployee, currentEmployeeData, setIsEditing }) {
    ...
    const [updatedSkillLevel, setUpdatedSkillLevel] = useState(
        currentEmployeeData.skill_level,
    );
    const [updatedAvatarUrl, setUpdatedAvatarUrl] = useState(
        currentEmployeeData.avatar_url,
    );
        ...
        <form onSubmit={handleEmployeeSubmit} className="employee-form">
            ...
            <div className="employee-form__group">
                ...
                <input
                    ...
                    onChange={memSetUpdatedFirstname}
                />
            </div>
            <div className="employee-form__group">
                ...
                <input
                    ...
                    onChange={memSetUpdatedLastName}
                />
            </div>
            <div className="employee-form__group">
                ...
                <input
                    ...
                    id="email"
                    value={updatedEmail}
                    onChange={memSetUpdatedEmail}
                />
            </div>
            <div className="employee-form__group">
                <label htmlFor="skill-level" className="employee-form__label">
                    Skill Level
                </label>
                <input
                    type="number"
                    className="employee-form__input"
                    id="skill-level"
                    value={updatedSkillLevel}
                    onChange={memSetUpdatedSkillLevel}
                />
            </div>
            <div className="employee-form__group">
                <label htmlFor="avatar-url" className="employee-form__label">
                    Avatar URL
                </label>
                <input
                    type="text"
                    ...
                    onChange={memSetUpdatedAvatarUrl}
                />
            </div>
            <button type="submit" className="employee-form__submit">
                Submit
            </button>
        </form>
    );
