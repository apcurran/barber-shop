        ...
        <section className="shop-staff">
            ...
            <div className="shop-staff__employees-container">
                {employeesArr.map((employee) => (
                    <div
                        className="shop-staff__employee"
                    ...
                    >
                        <figure className="shop-staff__employee__fig">
                            <img
                                ...
                                alt="Employee avatar"
                                className="shop-staff__employee__img"
                                width="128"
                                height="128"
                                loading="lazy"
                            />
                        </figure>
                        <h3 className="shop-staff__employee__name">
                            {employee.first_name}
                        </h3>
                        <p className="shop-staff__employee__level">
                            Level {employee.skill_level} Barber
                        </p>
                    </div>
                ))}
            </div>
