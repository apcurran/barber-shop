                ...
                >
                    ...
                    <div className="appointments-list__card__info-group-wrapper">
                        <div className="appointments-list__card__info-container">
                            <h3 className="appointments-list__card__info__title">
                                Customer Name
                            </h3>
                            <p className="appointments-list__card__info__value">
                    ...
                    <button
                        onClick={() =>
                            handleAppointmentDelete(appointment.appointment_id)
                        }
                        className="appointments-list__card__delete-btn"
                    >
                        Done
                    </button>
                </motion.article>
