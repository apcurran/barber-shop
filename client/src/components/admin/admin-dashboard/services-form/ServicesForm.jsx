...
import {
    addService,
    patchService,
} from "../../../../store/actions/admin-services-actions";
    ...
    return (
        <form onSubmit={handleServiceFormSubmit} className="employee-form">
            ...
            <div className="employee-form__group">
                <label htmlFor="title" className="employee-form__label">
                    Title
                </label>
                <input
                    type="text"
                    ...
                    id="title"
                    value={updatedTitle}
                    onChange={memSetUpdatedTitle}
                />
            </div>
            <div className="employee-form__group">
                <label htmlFor="content" className="employee-form__label">
                    Content
                </label>
                <textarea
                    className="employee-form__input"
                    ...
                    onChange={memSetUpdatedContent}
                ></textarea>
            </div>
            <div className="employee-form__group">
                <label htmlFor="price" className="employee-form__label">
                    Price
                </label>
                <input
                    type="number"
                    ...
                    id="price"
                    value={updatedPrice}
                    onChange={memSetUpdatedPrice}
                />
            </div>
            <div className="employee-form__group">
                <label htmlFor="img-url" className="employee-form__label">
                    Image URL
                </label>
                <input
                    type="text"
